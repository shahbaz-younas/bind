...
/**
 * Created by qboxus on 12/4/2018.
 */

// this class will get the latest version of app from play store if the app is publish into play store
public class VersionChecker extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        Log.d(Constants.tag, "versionname: "+versionname);
        Log.d(Constants.tag, "latestVersion: "+latestVersion);
