package com.qboxus.binderstatic.SimpleClasses;
...
public class Variables {
    ...
    public static String userSuperlikeLimit = "userSuperLikeLimit";

    public static String boostOnTime ="Boost_On_Time";
    public static String contactsFetchTime = "contactsFetchTime";
    ...
    public static final int PERMISSION_CONTACTS = 792;
    public static final int SELECT_IMAGE_FROM_GALLRY_CODE = 3;
    public static final String FRAGMENT_CALLBACK_REQUEST_KEY = "112";
